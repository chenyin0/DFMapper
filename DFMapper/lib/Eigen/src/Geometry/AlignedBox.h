...
/** \geometry_module \incluster Geometry_Module
  *
  *
  * \class AlignedBox
  *
...
/** \defcluster alignedboxtypedefs Global aligned box typedefs
  *
  * \incluster Geometry_Module
  *
