...
#include "../arch/arch_block_net.hpp"
...
namespace DFMpr
{
	...
	interface Resource
	{
		...
		virtual vector<uint> getAllPreId() const = 0;
	...
	public:
		...
		vector<uint> getAllPreId() const override;
	};
	...
	public:
		...
		vector<uint> next_port_id;
		vector<uint> pre_wire_id;
		vector<uint> pre_segment_id;
		vector<uint> pre_block_id;
		vector<uint> pre_port_id;
